...
int main() {
	...
	*/
	// VERSION CORRIGÉE
	int tailleTAB = 5*sizeof(int); //on a des int et non des int * car ce sont des décalage et non pas des adresses
	...
	sleep(40);
	printf("fin attente\n");
	shmdt(memoiredebut); //détachement de la shm
	shmctl(shmid,IPC_RMID,NULL); //libération du segment memoire
